...
class ReceitaForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cliente'].widget = ModelSelect2Widget(
            model=Cliente,
            search_fields=['nm_cliente__icontains'],
            attrs={'data-placeholder': 'Selecione um cliente'}
        )
        self.helper = FormHelper(self)
    ...
    class Meta:
        model = Receita
        fields = ['valor','data_entrada','cliente','forma_recebimento','situacao','observacoes','tipo_recebimento']
