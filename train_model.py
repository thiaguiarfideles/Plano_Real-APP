...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'core.settings')  # Substitua 'core.settings' pelo caminho correto

# Inicializar o Django
django.setup()

# Importar os modelos depois de configurar o Django
from agendaFinanceira.models import Receita, Despesa
