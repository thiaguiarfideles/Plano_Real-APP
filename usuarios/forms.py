...
class CustomUserCreationForm(UserCreationForm):
    class Meta(UserCreationForm.Meta):
        model = User
        fields = ('email',)  # Apenas o campo 'email' é mantido no formulário de criação de usuário
...
class UserProfileForm(ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ['nm_completo', 'nr_cpf_cgc','foto_perfil', 'observacoes', 'tipo_usuario', 'nrTelCelular']
        # exclude = ['user']
